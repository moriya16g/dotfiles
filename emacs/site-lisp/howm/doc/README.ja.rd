...
= howm (一人お手軽 Wiki もどき)
$Id: README.ja.rd,v 1.303 2009-07-23 14:08:50 hira Exp $
...
* テスト版
  * [2009-07-23]
    * fix: (setq howm-list-title t) していたら,
      come-from リンク上で RET したときもタイトル一覧を表示するように.
      ((<thx|URL:http://pc11.2ch.net/test/read.cgi/unix/1141892764/762>))
      * もし以前の動作がよければ, M-x customize-variable howm-list-title RET
        し, howm-keyword-search 以外をすべてセットしてください.
  * [2009-06-08]
    * 過ぎた〆切に着色
      ((<thx|URL:http://pc11.2ch.net/test/read.cgi/unix/1141892764/738>))
  * [2009-06-01]
    * fix: C-c , l (howm-list-recent)時に該当ファイルが多すぎるとエラー.
  ...
  * [2009-02-05]
    ...
    * fix: メモを保存したときにメニューが自動更新されなくなっていた.
