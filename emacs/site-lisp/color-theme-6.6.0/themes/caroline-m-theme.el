...
;; held my hand all through Burbon Street
  (custom-theme-set-faces
   ...
   'caroline-m ;; Some of the bluest eyes you have ever seen
...
;;	 (markdown-link-face ((t (:foreground ,caroline-blue :underline t))))
   ...
   `(org-level-1 ((t (:inherit outline-1
                         :weight bold
                         :height 1.3))))
   `(org-level-2 ((t (:inherit outline-2 :height 1.2 :foreground, caroline-yellow :weight bold))))
   `(org-level-3 ((t (:inherit outline-3 :height 1.1 :foreground, caroline-magenta :weight bold))))
   `(org-level-4 ((t (:inherit outline-4 :height 1.0 :foreground, caroline-skyblue))))
...
(provide-theme 'caroline-m)
;;; caroline-m-theme.el ends here
